...
namespace GMap.NET.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   查找类似 CREATE TABLE IF NOT EXISTS Tiles (id INTEGER NOT NULL PRIMARY KEY, gid INTEGER, parent_gid INTEGER, X INTEGER NOT NULL, Y INTEGER NOT NULL, Zoom INTEGER NOT NULL, Type UNSIGNED INTEGER  NOT NULL, CacheTime DATETIME);
        ...
        ///CREATE TRIGGER fki_TilesData_id_Til [字符串的其余部分被截断]&quot;; 的本地化字符串。
        /// </summary>
