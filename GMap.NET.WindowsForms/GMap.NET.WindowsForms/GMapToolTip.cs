...
using System.Collections;
...
#endif
   {
...
#if !PocketPC
      public static readonly Pen DefaultStroke = new Pen(Color.Transparent);
#else
...
#if !PocketPC
      public static readonly Brush DefaultFill = new SolidBrush(Color.Transparent);
#else
      ...
      public static readonly Brush DefaultForeground = new SolidBrush(Color.Red);
      ...
      public virtual void OnRender(Graphics g)
      {
         System.Drawing.Size st = g.MeasureString(Marker.ToolTipText, Font).ToSize();
          //  Point startRect = new Point ((Marker.LocalArea.Left +Marker.LocalArea.Right)/2 - st.Width/2,Marker.LocalArea.Top - st.Height);
         System.Drawing.Rectangle rect = new System.Drawing.Rectangle((Marker.LocalArea.Left + Marker.LocalArea.Right) / 2 - st.Width / 2, Marker.LocalArea.Top - st.Height, st.Width + TextPadding.Width, st.Height + TextPadding.Height);
